 ...
 */
final class Version20220521131457 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE calendar ADD id_user_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE calendar ADD CONSTRAINT FK_6EA9A14679F37AE5 FOREIGN KEY (id_user_id) REFERENCES user (id)');
        $this->addSql('CREATE INDEX IDX_6EA9A14679F37AE5 ON calendar (id_user_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE rdv (id INT AUTO_INCREMENT NOT NULL, id_installation_id INT DEFAULT NULL, id_professionnel_id INT DEFAULT NULL, date DATETIME NOT NULL, type VARCHAR(45) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, tarification DOUBLE PRECISION NOT NULL, INDEX IDX_10C31F8669C39953 (id_professionnel_id), INDEX IDX_10C31F86FF254B3C (id_installation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE calendar DROP FOREIGN KEY FK_6EA9A14679F37AE5');
        $this->addSql('DROP INDEX IDX_6EA9A14679F37AE5 ON calendar');
        $this->addSql('ALTER TABLE calendar DROP id_user_id');
    }
}
